...
import parser.dataobjects.Firma;
import parser.dataobjects.Oddzial;
import parser.dataobjects.Uprawnienie;
...
public class MyHandler extends DefaultHandler{
    ...
    public MyHandler(FileWriter outSFirma,
                     FileWriter outSUprawnienie,
                     FileWriter outSOddzial,
                     FileWriter outExAddress,
                     FileWriter outTeryt){
        super();
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        if (qName.equalsIgnoreCase("InformacjaOWpisie")) {
            ...
            try {
                ...
                if(!firma.isAdresEmpty()) {
                    outSFirma.write(Parser.cleanString(firma.withAddressToString())
                            + Parser.lineSeparator);
                //zapisujemy do strumienia pliku bez adresów
                } else if(outExAddress != null){
                    outExAddress.write(Parser.cleanString(firma.noAddressToString())
                            + Parser.lineSeparator);
                }
