...
import parser.springlogger.MyLoggerConfig;
...
//        setComponents();
    ...
    public static void main(String[] args) {
        AnnotationConfigApplicationContext context =
                new AnnotationConfigApplicationContext(ParserConfig.class, MyLoggerConfig.class);
        Parser parser = context.getBean(Parser.class);
        parser.setComponents(context);

    }

    private void setComponents(AnnotationConfigApplicationContext context){
        ...
        Action actionAdd = context.getBean("actionAdd", ActionAdd.class);
        Action actionDelete = context.getBean("actionDelete", ActionDelete.class);
        Action actionStart = context.getBean("actionStart", ActionStart.class);
        Action actionExit = context.getBean("actionExit", ActionExit.class);
